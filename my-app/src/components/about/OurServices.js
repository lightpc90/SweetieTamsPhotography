...
const OurServices = () => {
  return (
    <div>
      <div className="flex flex-col mt-4 p-5 lg:text-2xl">

        <p>
          Creating beautiful stories is my way of life. This is why photography
          for me has gone beyond just clicking the shutter button! Your story is
          my priority.
        </p>
        <p>
