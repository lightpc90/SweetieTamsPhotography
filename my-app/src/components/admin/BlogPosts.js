  ...
  return (
    <div className="flex flex-col gap-3 justify-center items-center">
      ...
      <div className="flex flex-col w-10/12 lg:w-8/12  justify-center items-center">
        <h2 className="text-4xl font-bold mb-8">Published Blog Posts</h2>
      ...
      <div className="flex flex-col w-10/12 lg:w-8/12  justify-center items-center">
        <h2 className="text-4xl font-bold mb-8">Scheduled Blog Posts</h2>
        <div className="flex min-h-[200px] lg:min-h-[300px] font-bold w-full justify-center items-center border-4 my-3 border-gray-400">
      ...
      {/* Draft Blog Posts */}
      <div className="flex flex-col w-10/12 lg:w-8/12  justify-center items-center">
        <h2 className="text-4xl font-bold mb-8">Draft Blog Posts</h2>
        <div className="flex min-h-[200px] lg:min-h-[300px] font-bold w-full justify-center items-center border-4 my-3 border-gray-400">
